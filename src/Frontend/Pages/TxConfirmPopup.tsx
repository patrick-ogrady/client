    ...
    <StyledTxConfirmPopup>
      ...
      <div>
        ...
        {method === 'buyCredits' && (
          <>
            ...
            <div>
              <b>Cost</b>
              <span>{buyGPTCreditsCost} WGM</span>
            </div>
          </>
        )}
      </div>
      ...
      <div>
        ...
        <div>
          ...
          <span>{txCost.toFixed(8)} WGM</span>
        </div>
        ...
        <div className='mtop'>
          <b>Account Balance</b>
          <span>{parseFloat(balance).toFixed(8)} WGM</span>
        </div>
        <div className='mtop'>
      ...
      <div>
        <div>
          <span>
            <ConfirmIcon /> DF connected to WGM
          </span>
          <span>
